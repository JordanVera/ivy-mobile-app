        ...
        >
          ...
          {isSignedIn ? (
            <View className="mb-4 rounded-2xl border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-900">
              <TextInput
                className="min-h-[88px] rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2.5 text-[15px] leading-6 text-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
